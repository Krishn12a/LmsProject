...
const CourseListComp = () => {
  ...
  const handlemodulechange = (event) => {
    ...
    console.log('Selected course:', selectedmoduleName);
    setmoduleName(selectedmoduleName);
  };
  ...
  const handleSubmit = () => {
    ...
    if (!courseName || !moduleName || !selectedDate) {
      ...
      <h2 className="text-center m-4">Mark Attendance</h2>
        <form className='form-group' style={{textAlign:'left'}}>
          ...
          <div >
            ...
            <select name="moduleName" id="mname" onChange={handlemodulechange}>
