...
const StudentComp = () => {
    ...
    const [selectedAttendanceStatus, setSelectedAttendanceStatus] = useState(''); // Added state for dropdown
    ...
    const handleDropdownChange = (event) => {
        ...
        // Set the attendance status for all students based on the dropdown value
        ...
        <div className='container-fluid stdC d-flex align-items-center justify-content-center'>
            <div className='stdC'>
                <div className='text-center'>
                    ...
                    {/* Dropdown for selecting attendance status */}
                    <div className="mb-2">
                        <label htmlFor="attendanceStatusDropdown" className="form-label"></label>
                        <select
                            className="form-select"
                            id="attendanceStatusDropdown"
